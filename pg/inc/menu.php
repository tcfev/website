<nav class="f-row menu">
    <ul class="dsp-f m-b-6 aic jcb p-x-5 jcb-s fs-s-s w-100p">
        ...
        <li><a href="membership"><?php echo $langs['menu'][$l]['membership']; ?></a></li>
        <li><a href="contact"><?php echo $langs['menu'][$l]['contact']; ?></a></li>
        <li><a href="supprot-request"><?php echo $langs['menu'][$l]['forms']; ?></a></li>
