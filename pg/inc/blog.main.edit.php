<div class="container-7 m-a popup" id="blog-title-dialog" kc-mode="kc-slider">
    <h4 class="cl-grey-8 m-b-4">Edit blog title</h4>
    <div id="blog-title-dialog-holder">
        <div class="karaco-sample-dom m-1" kc-mode="kc-slide" kc-ord="[[Row]]" kc-label="[[lang]]">
            <form kc-mode="form-submit" kc-func="blogTitle">
...
<div class="container-7 m-a popup" id="blog-exp-dialog" kc-mode="kc-slider">
    <h4 class="cl-grey-8 m-b-4">Edit blog explanation</h4>
    <div id="blog-exp-dialog-holder">
        <div class="karaco-sample-dom m-1" kc-mode="kc-slide" kc-ord="[[Row]]" kc-label="[[lang]]">
            <form kc-mode="form-submit" kc-func="blogExp">
                <span>SEO Description - [[lang]]</span></br>
                <textarea type="text" class="p-1 dsp-b m-a w-100p m-w-100p i-w-100p i-h-200px" style="max-width: 280px;width:280px" name="e" placeholder="SEO Description - [[lang]]">[[descr]]</textarea>
                <input type="hidden" name="i" value="[[ID]]">
                <button type="submit" class="p-1 m-t-1 m-b-3">Submit</button>
            </form>
        </div>
...
<div class="container-7 m-a popup" id="blog-descr-dialog" kc-mode="kc-slider">
    <h4 class="cl-grey-8 m-b-4">Edit photo description</h4>
    <div id="blog-descr-dialog-holder">
        <div class="karaco-sample-dom m-1" kc-mode="kc-slide" kc-ord="[[Row]]" kc-label="[[lang]]">
            <form kc-mode="form-submit" kc-func="blogDescr">
                <span>Description - [[lang]]</span></br>
                <div class="editor"><p>[[body]]</p></div>
