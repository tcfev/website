<div class="container-7 m-a popup" id="blog-image-dialog">
    <form kc-mode="form-submit" kc-func="submitBlogImage">
...
<div class="container-7 m-a popup" id="blog-image-title-dialog" kc-mode="kc-slider">
    <h4 class="cl-grey-8 m-b-4">Edit photo title</h4>
    <div id="blog-image-title-dialog-holder">
        <div class="karaco-sample-dom m-1" kc-mode="kc-slide" kc-ord="[[Row]]" kc-label="[[lang]]">
            <form kc-mode="form-submit" kc-func="blogImageTitle">
