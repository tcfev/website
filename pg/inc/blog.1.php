<div class="f-row aic m-t-9 m-b-5">
    <h2 class="dsp-ib">Blogs</h2>
    <span class="bx-btn m-x-4 bg-yellow-4 cl-white tp" kc-mode="func-btn" kc-func="addBlog">+<div class="tt ttop bg-grey-7 cl-white">Add</div></span>
</div>

<div class="f-row jca" id="blogs">
    <div class="f-holder-1 dsp-f ais over-menu-holder karaco-sample-dom">
        <div class="f-holder-1 bg-white shdw-3 brr-2 resizable [[class]]">
            <div class="m-b-4">
                <label class="switch big">
                    <input type="checkbox" name="act" [[active]] kc-mode="func-btn" kc-func="blogActive" kc-id="[[ID]]">
        ...
        <div class="over-menu bg-red-2 over-row top-right">
            ...
            <span class="over-item cl-white hvr-cl-blue-4 tp" kc-mode="func-btn" kc-id="[[ID]]" kc-func="deleteBlogDialog">
                X
...
<?php include_once 'blog.main.edit.php'; ?>
<?php include_once 'blog.gallery.edit.php'; ?>
<?php include_once 'blog.video.edit.php'; ?>
