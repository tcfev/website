<div class="f-row aic m-t-9 m-b-5">
    ...
    <span class="bx-btn m-x-4 bg-bright-green-6 cl-white tp" kc-mode="func-btn" kc-func="addBlogVideo" kc-id="[[ID]]">+<div class="tt ttop bg-grey-7 cl-white">Add</div></span>
</div>
...
<div class="f-row" kc-arr="[[$videos]]">
    <div class="f-holder-3 dsp-f ais over-menu-holder karaco-sample-dom">
            ...
            <div class="f-row">
                <div class="over-menu-holder video-container">
                    ...
                    <div class="over-menu bg-white over-row top-center">
                        <span class="over-item cl-black icon-edit hvr-cl-blue-4 tp" kc-mode="func-btn" kc-id="[[ID]]" kc-func="startBlogVideo">
                ...
                <div class="f-row">
                    <div class="over-menu-holder p-2">
                        ...
                        <div class="over-menu bg-white over-row top-right">
                            <span class="over-item cl-black icon-edit hvr-cl-blue-4 tp" kc-mode="func-btn" kc-id="[[ID]]" kc-func="startBlogVideoTitle">
                                <div class="tt ttop bg-grey-7 brr-5px cl-white">Edit</div>
                            </span>
                        </div>
                    </div>
        ...
        <div class="over-menu bg-red-2 over-row top-right">
            <span class="over-item cl-white hvr-cl-blue-4 tp" kc-mode="func-btn" kc-id="[[ID]]" kc-func="deleteBlogVideoDialog">
                X
